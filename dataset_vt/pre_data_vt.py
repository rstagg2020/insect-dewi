...
class Dataset():
    def __init__(self, input_size, root, dataset_path, mode='train'):
        ...
        train_label_file = open(os.path.join(self.root, 'dataset_vt', 'train.txt'))
        val_label_file = open(os.path.join(self.root, 'dataset_vt', 'val.txt'))
        test_label_file = open(os.path.join(self.root, 'dataset_vt', 'test.txt'))
